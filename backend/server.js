...
// Set the correct origin dynamically
const currentFrontendUrl = process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : (process.env.FRONTEND_URL || 'http://localhost:5173');

// --- Middleware ---
const corsOptions = {
    origin: currentFrontendUrl,
    credentials: true
};
