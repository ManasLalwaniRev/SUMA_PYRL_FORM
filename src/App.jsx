...
import LoginPage from './components/LoginPage';
import HomePage from './components/HomePage';
import PayrollFormPage from './components/PayrollFormPage';
import { HomeIcon, FileTextIcon } from './components/Icons';
        ...
        <nav className="flex items-center justify-between p-4 bg-white shadow-md">
          <div className="flex space-x-4">
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-2 rounded-full transition duration-300 ${currentPage === 'home' ? 'bg-indigo-600 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-200'}`}
            >
              <HomeIcon size={20} />
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-2 rounded-full transition duration-300 ${currentPage === 'payroll' ? 'bg-indigo-600 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-200'}`}
            >
              <FileTextIcon size={20} />
              <span className="font-medium hidden sm:block">Payroll</span>
            </button>
          </div>
          <button
